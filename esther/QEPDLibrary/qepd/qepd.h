...
enum CodigoDeOperacion {
	...
	MENSAJE, ABRIR_ARCHIVO, LEER_ARCHIVO, ESCRIBIR_ARCHIVO, CERRAR_ARCHIVO, PEDIR_MEMORIA_VARIABLE_OK, QUANTUM, ASIGNAR_VALOR_VARIABLE_OK, RETORNAR_VARIABLE_OK, PEDIR_MEMORIA_OK, // Mensajes provenientes de Kernel
	PCB_COMPLETO, PCB_EXCEPCION, OBTENER_VALOR_VARIABLE, PEDIR_MEMORIA_VARIABLE, ASIGNAR_VALOR_VARIABLE, INSTRUCCION, RETORNAR_VALOR, PEDIR_MEMORIA, // Mensajes provenientes de la CPU

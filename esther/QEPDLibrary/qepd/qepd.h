...
enum CodigoDeOperacion {
	...
	MENSAJE, ABRIR_ARCHIVO, LEER_ARCHIVO, ESCRIBIR_ARCHIVO, CERRAR_ARCHIVO, PEDIR_MEMORIA_VARIABLE_OK, QUANTUM, ASIGNAR_VALOR_VARIABLE_OK, RETORNAR_VARIABLE_OK, // Mensajes provenientes de Kernel

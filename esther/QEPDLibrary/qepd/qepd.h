...
enum CodigoDeOperacion {
	...
	//Consola - Kernel
	INICIAR_PROGRAMA, PAGINAS_STACK, DESCONECTAR_CONSOLA, IMPRIMIR,
	...
	//DEPRECATED (sin uso pero se lo deja temporalmente para no molestar
	//a los procesos que lo tienen por ahí)
	INSTRUCCION
};

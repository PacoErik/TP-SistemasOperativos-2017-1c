...
enum CodigoDeOperacion {
	...
	EXCEPCION_DE_SOLICITUD, PCB_INCOMPLETO, INICIAR_PROGRAMA, FRAME_SIZE, DESCONECTAR_CONSOLA,// Mensajes provenientes de procesos varios
	MENSAJE, ABRIR_ARCHIVO, LEER_ARCHIVO, ESCRIBIR_ARCHIVO, CERRAR_ARCHIVO, PEDIR_MEMORIA_VARIABLE_OK, QUANTUM, QUANTUM_SLEEP, // Mensajes provenientes de Kernel
	DESCONEXION_CPU, PCB_COMPLETO, PCB_EXCEPCION, OBTENER_VALOR_VARIABLE, PEDIR_MEMORIA_VARIABLE, ASIGNAR_VALOR_VARIABLE, INSTRUCCION, RETORNAR_VALOR, // Mensajes provenientes de la CPU

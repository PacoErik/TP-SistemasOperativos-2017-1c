...
enum CodigoDeOperacion {
	...
	PCB_COMPLETO, PCB_EXCEPCION, OBTENER_VALOR_VARIABLE, PEDIR_MEMORIA_VARIABLE, ASIGNAR_VALOR_VARIABLE, INSTRUCCION, RETORNAR_VALOR, // Mensajes provenientes de la CPU
